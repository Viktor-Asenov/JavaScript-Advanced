...
describe("Tests", function () {
  describe("isItExpensive", function () {
    it("should return the cost will be more expensive when issue is engine or transmission", function () {
    ...
    it("should return the price will be a bit more cheaper when issue is different", function () {
